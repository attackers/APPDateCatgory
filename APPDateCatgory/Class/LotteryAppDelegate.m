...
@interface LotteryAppDelegate ()<UNUserNotificationCenterDelegate,JPUSHRegisterDelegate,WXApiDelegate>
@end
...
//    _mAPPDelegate = [[MFSCAppDelegate alloc]init];
//    BOOL first = [defaults objectForKey:@"noFirst"];
//    if (!first) {
//        [defaults setBool:YES forKey:@"noFirst"];
//        [defaults setObject:[NSDate date] forKey:@"appDate"];
//        return [_mAPPDelegate application:application didFinishLaunchingWithOptions:launchOptions];
//    } else {
//        NSDate *date = [defaults objectForKey:@"appDate"];
//        NSInteger howDate = [NSDate dateToDateBetweenHowDay:date nowDate:[NSDate date]];
//        if (howDate < 20) {
//            return [_mAPPDelegate application:application didFinishLaunchingWithOptions:launchOptions];
//        }
//    }
...
//
//    UMConfigInstance.appKey = @"5b050ae6a40fa36907000083";
//    UMConfigInstance.channelId = [NSString stringWithFormat:@"%@-95c",app_Version];
