...
-(void)goToMineViewControllerAction
{
    ...
    [app.lotteryDelegate.maiTabBarController goToMineViewController];
}
...
-(void)clickHotLottery:(CPLotteryModel *)hotLottery
{
    if ([CPGlobalDataManager shareGlobalData].isReviewVersion) {
        AppDelegate *app = (AppDelegate *)[UIApplication sharedApplication].delegate;
        app.lotteryDelegate.maiTabBarController.selectedIndex = 1;
    ...
    switch (sender.tag) {
        case 10:
        {
            ...
            if ([self verifySignInfoIsSignIn]) {
                AppDelegate *app = (AppDelegate *)[UIApplication sharedApplication].delegate;
                app.lotteryDelegate.maiTabBarController.selectedIndex = app.lotteryDelegate.maiTabBarController.viewControllers.count-1;
            }
