...
{
    [super awakeFromNib];
    _tvBgView.layer.borderWidth = 1.0f;
    _tvBgView.layer.borderColor = kCOLOR_R_G_B_A(200, 200, 200, 1).CGColor;
      ...
      attentionText:(NSString *)attentionText
{
    ...
    _tvView.text = @"";
    _tvView.placeholderTextColor = kCOLOR_R_G_B_A(200, 200, 200, 1);
