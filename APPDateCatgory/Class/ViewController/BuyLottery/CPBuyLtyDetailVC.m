...
-(void)setSelectedMenuIndex:(NSInteger)selectedMenuIndex
{
    ...
    if (_isOfficailPlay) {
        ...
        NSDictionary *playInfo = [NSDictionary dictionary];
        if (self.menuPlayKindList.count) {
            playInfo = self.menuPlayKindList[_selectedMenuIndex];
        }
...
-(void)reloadBottonView
{
    ...
    [cleanChooseButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_clean_choose_unclick"] forState:UIControlStateNormal];
    [cleanChooseButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_clean_choose_click"] forState:UIControlStateHighlighted];
    [cleanChooseButton setTitle:@"清空选项" forState:UIControlStateNormal];
    cleanChooseButton.titleLabel.font = [UIFont systemFontOfSize:15.0f];
//    [cleanChooseButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [cleanChooseButton setTitleColor:RGBA(51, 51, 51, 1) forState:UIControlStateNormal];
    ...
    if (_isOfficailPlay) {
        ...
        [officailRuleButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_clean_choose_unclick"] forState:UIControlStateNormal];
        [officailRuleButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_clean_choose_click"] forState:UIControlStateHighlighted];
        [officailRuleButton setTitle:@"玩法说明" forState:UIControlStateNormal];
        officailRuleButton.titleLabel.font = [UIFont systemFontOfSize:15.0f];
//        [officailRuleButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [officailRuleButton setTitleColor:RGBA(51, 51, 51, 1) forState:UIControlStateNormal];
    ...
    [betButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_bet_unclick"] forState:UIControlStateNormal];
    [betButton setBackgroundImage:[UIImage imageNamed:@"buy_lty_bet_click"] forState:UIControlStateHighlighted];
    [betButton setTitle:@"投注" forState:UIControlStateNormal];
    betButton.titleLabel.font = [UIFont systemFontOfSize:15.0f];
    [betButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    [betButton setTitleColor:RGBA(51, 51, 51, 1) forState:UIControlStateNormal];
...
-(void)buildContentView
{
    ...
    [_menuTableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(kScreenWidth*105/375.0f);
    }];
    
    UIImageView *contentTableViewBgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"buylty_content_bg_right"]];
    contentTableViewBgView.userInteractionEnabled = YES;
    contentTableViewBgView.frame = CGRectMake(_menuTableView.rightX, 0, _contentBgView.width-_menuTableView.width, _contentBgView.height);
    [_contentBgView addSubview:contentTableViewBgView];
    [contentTableViewBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_contentBgView.mas_top);
        make.bottom.equalTo(_contentBgView.mas_bottom);
    ...
    [_contentTableView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_contentBgView.mas_top).offset(gap);
        make.bottom.equalTo(_contentBgView.mas_bottom);
        make.right.equalTo(_contentBgView.mas_right);
        make.left.equalTo(_menuTableView.mas_right);
    }];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (_isOfficailPlay) {
        ...
        NSDictionary *playDetailInfo = [NSDictionary dictionary];
        if (self.contentPlayDetailList.count) {
            playDetailInfo = self.contentPlayDetailList[section];
        }
...
-(void)cpBuyLtyRightButtonItemSortActionByTag:(NSInteger)tag
{
    switch (tag) {
        case 11:
        {
            ...
            [app.lotteryDelegate.maiTabBarController goToHomepageViewController];
        ...
        case 12:
        {
            ...
            if (![SUMUser shareUser].isLogin) {
                AppDelegate *app = (AppDelegate *)[UIApplication sharedApplication].delegate;
                [app.lotteryDelegate.maiTabBarController goToLoginViewController];
            }else{
...
//            UIColor *lightColor = kCOLOR_R_G_B_A(1,53,66, 1);
            UIColor *lightColor = kCOLOR_R_G_B_A(51,51,51, 1);
