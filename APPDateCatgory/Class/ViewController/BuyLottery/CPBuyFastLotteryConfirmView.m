...
-(void)awakeFromNib
{
    ...
    _cleanBtn.layer.cornerRadius = 5.0f;
    _cleanBtn.layer.masksToBounds = YES;
    _yuanButton.layer.cornerRadius = 5.0f;
    _yuanButton.layer.masksToBounds = YES;
    _jiaoButton.layer.cornerRadius = 5.0f;
...
//    _contentView.layer.borderColor = kCOLOR_R_G_B_A(109, 195, 214, 1).CGColor;
    _contentView.layer.borderColor = kCOLOR_R_G_B_A(255, 206, 186, 1).CGColor;
...
//    NSMutableAttributedString * topAtt = [[NSMutableAttributedString alloc]initWithString:topTitle attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15],NSForegroundColorAttributeName:kCOLOR_R_G_B_A(178, 222, 234, 1)}];
    NSMutableAttributedString * topAtt = [[NSMutableAttributedString alloc]initWithString:topTitle attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15],NSForegroundColorAttributeName:kCOLOR_R_G_B_A(51, 51, 51, 1)}];
//    [topAtt addAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]} range:[topTitle rangeOfString:numberPeriods]];
    [topAtt addAttributes:@{NSForegroundColorAttributeName:kMainColor} range:[topTitle rangeOfString:numberPeriods]];
